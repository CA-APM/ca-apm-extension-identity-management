/**
 * TemplateEmployeeSelfModification.java
 *
...
public class TemplateEmployeeSelfModification  implements java.io.Serializable {
    private tews6.wsdl.TemplateEmployeeSelfModificationUserProfileTab templateEmployeeSelfModificationUserProfileTab;

    public TemplateEmployeeSelfModification() {
    }
    ...
    /**
     * Gets the templateEmployeeSelfModificationUserProfileTab value for this TemplateEmployeeSelfModification.
     * 
    ...
    /**
     * Sets the templateEmployeeSelfModificationUserProfileTab value for this TemplateEmployeeSelfModification.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TemplateEmployeeSelfModification)) return false;
        TemplateEmployeeSelfModification other = (TemplateEmployeeSelfModification) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TemplateEmployeeSelfModification.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tews6/wsdl", ">TemplateEmployeeSelfModification"));
