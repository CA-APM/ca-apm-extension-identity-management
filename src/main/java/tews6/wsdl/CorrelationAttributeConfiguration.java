/**
 * CorrelationAttributeConfiguration.java
 *
...
public class CorrelationAttributeConfiguration  implements java.io.Serializable {
    ...
    public CorrelationAttributeConfiguration() {
    }
    ...
    /**
     * Gets the correlationAttributeConfigurationCorrelationAttributeTagTab value for this CorrelationAttributeConfiguration.
     * 
    ...
    /**
     * Sets the correlationAttributeConfigurationCorrelationAttributeTagTab value for this CorrelationAttributeConfiguration.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CorrelationAttributeConfiguration)) return false;
        CorrelationAttributeConfiguration other = (CorrelationAttributeConfiguration) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CorrelationAttributeConfiguration.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tews6/wsdl", ">CorrelationAttributeConfiguration"));
