/**
 * TransferDocumentOwnershipSearchResultResultItem_PCT_LAST_NAME_PCT_.java
 *
...
public class TransferDocumentOwnershipSearchResultResultItem_PCT_LAST_NAME_PCT_  implements java.io.Serializable {
    ...
    public TransferDocumentOwnershipSearchResultResultItem_PCT_LAST_NAME_PCT_() {
    }
    ...
    /**
     * Gets the DISPLAY_NAME value for this TransferDocumentOwnershipSearchResultResultItem_PCT_LAST_NAME_PCT_.
     * 
     * @return DISPLAY_NAME
     */
    ...
    /**
     * Sets the DISPLAY_NAME value for this TransferDocumentOwnershipSearchResultResultItem_PCT_LAST_NAME_PCT_.
     * 
     * @param DISPLAY_NAME
     */
    ...
    /**
     * Gets the ATTR_NAME value for this TransferDocumentOwnershipSearchResultResultItem_PCT_LAST_NAME_PCT_.
     * 
     * @return ATTR_NAME
     */
    ...
    /**
     * Sets the ATTR_NAME value for this TransferDocumentOwnershipSearchResultResultItem_PCT_LAST_NAME_PCT_.
     * 
     * @param ATTR_NAME
     */
    ...
    /**
     * Gets the ATTR_VALUE value for this TransferDocumentOwnershipSearchResultResultItem_PCT_LAST_NAME_PCT_.
     * 
     * @return ATTR_VALUE
     */
    ...
    /**
     * Sets the ATTR_VALUE value for this TransferDocumentOwnershipSearchResultResultItem_PCT_LAST_NAME_PCT_.
     * 
     * @param ATTR_VALUE
     */
    ...
    /**
     * Gets the ATTR_PERMISSION value for this TransferDocumentOwnershipSearchResultResultItem_PCT_LAST_NAME_PCT_.
     * 
    ...
    /**
     * Sets the ATTR_PERMISSION value for this TransferDocumentOwnershipSearchResultResultItem_PCT_LAST_NAME_PCT_.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TransferDocumentOwnershipSearchResultResultItem_PCT_LAST_NAME_PCT_)) return false;
        TransferDocumentOwnershipSearchResultResultItem_PCT_LAST_NAME_PCT_ other = (TransferDocumentOwnershipSearchResultResultItem_PCT_LAST_NAME_PCT_) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TransferDocumentOwnershipSearchResultResultItem_PCT_LAST_NAME_PCT_.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tews6/wsdl", ">>>TransferDocumentOwnershipSearchResult>ResultItem>_PCT_LAST_NAME_PCT_"));
