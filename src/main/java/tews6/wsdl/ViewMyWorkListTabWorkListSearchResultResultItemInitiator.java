/**
 * ViewMyWorkListTabWorkListSearchResultResultItemInitiator.java
 *
...
public class ViewMyWorkListTabWorkListSearchResultResultItemInitiator  implements java.io.Serializable {
    ...
    public ViewMyWorkListTabWorkListSearchResultResultItemInitiator() {
    }
    ...
    /**
     * Gets the DISPLAY_NAME value for this ViewMyWorkListTabWorkListSearchResultResultItemInitiator.
     * 
     * @return DISPLAY_NAME
     */
    ...
    /**
     * Sets the DISPLAY_NAME value for this ViewMyWorkListTabWorkListSearchResultResultItemInitiator.
     * 
     * @param DISPLAY_NAME
     */
    ...
    /**
     * Gets the ATTR_NAME value for this ViewMyWorkListTabWorkListSearchResultResultItemInitiator.
     * 
     * @return ATTR_NAME
     */
    ...
    /**
     * Sets the ATTR_NAME value for this ViewMyWorkListTabWorkListSearchResultResultItemInitiator.
     * 
     * @param ATTR_NAME
     */
    ...
    /**
     * Gets the ATTR_VALUE value for this ViewMyWorkListTabWorkListSearchResultResultItemInitiator.
     * 
     * @return ATTR_VALUE
     */
    ...
    /**
     * Sets the ATTR_VALUE value for this ViewMyWorkListTabWorkListSearchResultResultItemInitiator.
     * 
     * @param ATTR_VALUE
     */
    ...
    /**
     * Gets the ATTR_PERMISSION value for this ViewMyWorkListTabWorkListSearchResultResultItemInitiator.
     * 
    ...
    /**
     * Sets the ATTR_PERMISSION value for this ViewMyWorkListTabWorkListSearchResultResultItemInitiator.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ViewMyWorkListTabWorkListSearchResultResultItemInitiator)) return false;
        ViewMyWorkListTabWorkListSearchResultResultItemInitiator other = (ViewMyWorkListTabWorkListSearchResultResultItemInitiator) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ViewMyWorkListTabWorkListSearchResultResultItemInitiator.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tews6/wsdl", ">>>ViewMyWorkList-Tab-WorkListSearchResult>ResultItem>initiator"));
