/**
 * OnboardAccountTabEndpointExploreSearchResultResultItem_PCT_CONTAINER_PCT_.java
 *
...
public class OnboardAccountTabEndpointExploreSearchResultResultItem_PCT_CONTAINER_PCT_  implements java.io.Serializable {
    ...
    public OnboardAccountTabEndpointExploreSearchResultResultItem_PCT_CONTAINER_PCT_() {
    }
    ...
    /**
     * Gets the DISPLAY_NAME value for this OnboardAccountTabEndpointExploreSearchResultResultItem_PCT_CONTAINER_PCT_.
     * 
     * @return DISPLAY_NAME
     */
    ...
    /**
     * Sets the DISPLAY_NAME value for this OnboardAccountTabEndpointExploreSearchResultResultItem_PCT_CONTAINER_PCT_.
     * 
     * @param DISPLAY_NAME
     */
    ...
    /**
     * Gets the ATTR_NAME value for this OnboardAccountTabEndpointExploreSearchResultResultItem_PCT_CONTAINER_PCT_.
     * 
     * @return ATTR_NAME
     */
    ...
    /**
     * Sets the ATTR_NAME value for this OnboardAccountTabEndpointExploreSearchResultResultItem_PCT_CONTAINER_PCT_.
     * 
     * @param ATTR_NAME
     */
    ...
    /**
     * Gets the ATTR_VALUE value for this OnboardAccountTabEndpointExploreSearchResultResultItem_PCT_CONTAINER_PCT_.
     * 
     * @return ATTR_VALUE
     */
    ...
    /**
     * Sets the ATTR_VALUE value for this OnboardAccountTabEndpointExploreSearchResultResultItem_PCT_CONTAINER_PCT_.
     * 
     * @param ATTR_VALUE
     */
    ...
    /**
     * Gets the ATTR_PERMISSION value for this OnboardAccountTabEndpointExploreSearchResultResultItem_PCT_CONTAINER_PCT_.
     * 
    ...
    /**
     * Sets the ATTR_PERMISSION value for this OnboardAccountTabEndpointExploreSearchResultResultItem_PCT_CONTAINER_PCT_.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OnboardAccountTabEndpointExploreSearchResultResultItem_PCT_CONTAINER_PCT_)) return false;
        OnboardAccountTabEndpointExploreSearchResultResultItem_PCT_CONTAINER_PCT_ other = (OnboardAccountTabEndpointExploreSearchResultResultItem_PCT_CONTAINER_PCT_) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OnboardAccountTabEndpointExploreSearchResultResultItem_PCT_CONTAINER_PCT_.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tews6/wsdl", ">>>OnboardAccount-Tab-EndpointExploreSearchResult>ResultItem>_PCT_CONTAINER_PCT_"));
