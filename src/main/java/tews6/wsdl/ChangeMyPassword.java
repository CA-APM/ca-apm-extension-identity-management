...
public class ChangeMyPassword  implements java.io.Serializable {
    ...
    /**
     * Gets the changeMyPasswordProfileTab value for this ChangeMyPassword.
     * 
    ...
    /**
     * Sets the changeMyPasswordProfileTab value for this ChangeMyPassword.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ChangeMyPassword)) return false;
        ChangeMyPassword other = (ChangeMyPassword) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ChangeMyPassword.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tews6/wsdl", ">ChangeMyPassword"));
