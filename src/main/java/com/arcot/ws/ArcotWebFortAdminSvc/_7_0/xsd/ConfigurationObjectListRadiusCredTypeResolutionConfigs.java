/**
 * ConfigurationObjectListRadiusCredTypeResolutionConfigs.java
 *
...
public class ConfigurationObjectListRadiusCredTypeResolutionConfigs  implements java.io.Serializable {
    ...
    /* Default RADIUS credential resolution
    ...
    public ConfigurationObjectListRadiusCredTypeResolutionConfigs() {
    }
    ...
    /**
     * Gets the globalConfigs value for this ConfigurationObjectListRadiusCredTypeResolutionConfigs.
     * 
    ...
    /**
     * Sets the globalConfigs value for this ConfigurationObjectListRadiusCredTypeResolutionConfigs.
     * 
    ...
    /**
     * Gets the orgLevelConfigs value for this ConfigurationObjectListRadiusCredTypeResolutionConfigs.
     * 
    ...
    /**
     * Sets the orgLevelConfigs value for this ConfigurationObjectListRadiusCredTypeResolutionConfigs.
     * 
    ...
    /**
     * Gets the defaultConfigName value for this ConfigurationObjectListRadiusCredTypeResolutionConfigs.
     * 
     * @return defaultConfigName   * Default RADIUS credential resolution
     * 									configuration name to
     * 									the organization.
     * 									The default configuration
     * 									is present in either globalConfigs or
    ...
    /**
     * Sets the defaultConfigName value for this ConfigurationObjectListRadiusCredTypeResolutionConfigs.
     * 
     * @param defaultConfigName   * Default RADIUS credential resolution
     * 									configuration name to
     * 									the organization.
     * 									The default configuration
     * 									is present in either globalConfigs or
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConfigurationObjectListRadiusCredTypeResolutionConfigs)) return false;
        ConfigurationObjectListRadiusCredTypeResolutionConfigs other = (ConfigurationObjectListRadiusCredTypeResolutionConfigs) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConfigurationObjectListRadiusCredTypeResolutionConfigs.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.arcot.com/ArcotWebFortAdminSvc/7.0/xsd", ">ConfigurationObjectList>radiusCredTypeResolutionConfigs"));
