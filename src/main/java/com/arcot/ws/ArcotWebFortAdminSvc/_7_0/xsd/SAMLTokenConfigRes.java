...
/**
 * SAMLTokenConfigResp is the structure used to
 * 				represent SAML token configuration.
 */
public class SAMLTokenConfigRes  extends com.arcot.ws.ArcotWebFortAdminSvc._7_0.xsd.SAMLTokenConfig  implements java.io.Serializable {
    /* Certificate details. */
    private com.arcot.ws.WebFortCommonAPI._7_0.xsd.CertificateDetails certDetails;

    public SAMLTokenConfigRes() {
    }
    ...
    /**
     * Gets the certDetails value for this SAMLTokenConfigRes.
     * 
    ...
    /**
     * Sets the certDetails value for this SAMLTokenConfigRes.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SAMLTokenConfigRes)) return false;
        SAMLTokenConfigRes other = (SAMLTokenConfigRes) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SAMLTokenConfigRes.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.arcot.com/ArcotWebFortAdminSvc/7.0/xsd", "SAMLTokenConfigRes"));
