/**
 * ConfigurationObjectListEmvOTPMasterKeyConfigs.java
 *
...
public class ConfigurationObjectListEmvOTPMasterKeyConfigs  implements java.io.Serializable {
    ...
    /* Default EMV OTP master key configuration name
     * 									to
     * 									the organization.
    ...
    public ConfigurationObjectListEmvOTPMasterKeyConfigs() {
    }
    ...
    /**
     * Gets the globalConfigs value for this ConfigurationObjectListEmvOTPMasterKeyConfigs.
     * 
    ...
    /**
     * Sets the globalConfigs value for this ConfigurationObjectListEmvOTPMasterKeyConfigs.
     * 
    ...
    /**
     * Gets the orgLevelConfigs value for this ConfigurationObjectListEmvOTPMasterKeyConfigs.
     * 
    ...
    /**
     * Sets the orgLevelConfigs value for this ConfigurationObjectListEmvOTPMasterKeyConfigs.
     * 
    ...
    /**
     * Gets the defaultConfigName value for this ConfigurationObjectListEmvOTPMasterKeyConfigs.
     * 
     * @return defaultConfigName   * Default EMV OTP master key configuration name
     * 									to
     * 									the organization.
     * 									The default configuration is present in
     * 									either globalConfigs or
    ...
    /**
     * Sets the defaultConfigName value for this ConfigurationObjectListEmvOTPMasterKeyConfigs.
     * 
     * @param defaultConfigName   * Default EMV OTP master key configuration name
     * 									to
     * 									the organization.
     * 									The default configuration is present in
     * 									either globalConfigs or
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConfigurationObjectListEmvOTPMasterKeyConfigs)) return false;
        ConfigurationObjectListEmvOTPMasterKeyConfigs other = (ConfigurationObjectListEmvOTPMasterKeyConfigs) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConfigurationObjectListEmvOTPMasterKeyConfigs.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.arcot.com/ArcotWebFortAdminSvc/7.0/xsd", ">ConfigurationObjectList>emvOTPMasterKeyConfigs"));
