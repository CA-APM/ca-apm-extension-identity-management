/**
 * ConfigurationObjectListArcotIDDomainKeyConfigs.java
 *
...
public class ConfigurationObjectListArcotIDDomainKeyConfigs  implements java.io.Serializable {
    ...
    /* Default arcotID domain key configuration name
     * 									to
     * 									the organization.
    ...
    public ConfigurationObjectListArcotIDDomainKeyConfigs() {
    }
    ...
    /**
     * Gets the globalConfigs value for this ConfigurationObjectListArcotIDDomainKeyConfigs.
     * 
    ...
    /**
     * Sets the globalConfigs value for this ConfigurationObjectListArcotIDDomainKeyConfigs.
     * 
    ...
    /**
     * Gets the orgLevelConfigs value for this ConfigurationObjectListArcotIDDomainKeyConfigs.
     * 
    ...
    /**
     * Sets the orgLevelConfigs value for this ConfigurationObjectListArcotIDDomainKeyConfigs.
     * 
    ...
    /**
     * Gets the defaultConfigName value for this ConfigurationObjectListArcotIDDomainKeyConfigs.
     * 
     * @return defaultConfigName   * Default arcotID domain key configuration name
     * 									to
     * 									the organization.
     * 									The default configuration is present in
     * 									either globalConfigs or
    ...
    /**
     * Sets the defaultConfigName value for this ConfigurationObjectListArcotIDDomainKeyConfigs.
     * 
     * @param defaultConfigName   * Default arcotID domain key configuration name
     * 									to
     * 									the organization.
     * 									The default configuration is present in
     * 									either globalConfigs or
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConfigurationObjectListArcotIDDomainKeyConfigs)) return false;
        ConfigurationObjectListArcotIDDomainKeyConfigs other = (ConfigurationObjectListArcotIDDomainKeyConfigs) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConfigurationObjectListArcotIDDomainKeyConfigs.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.arcot.com/ArcotWebFortAdminSvc/7.0/xsd", ">ConfigurationObjectList>arcotIDDomainKeyConfigs"));
