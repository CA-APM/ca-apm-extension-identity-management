/**
 * ConfigurationObjectListArcotOTPMasterKeyConfigs.java
 *
...
public class ConfigurationObjectListArcotOTPMasterKeyConfigs  implements java.io.Serializable {
    ...
    /* Default arcotOTP master key configuration name
     * 									to
     * 									the organization.
    ...
    public ConfigurationObjectListArcotOTPMasterKeyConfigs() {
    }
    ...
    /**
     * Gets the globalConfigs value for this ConfigurationObjectListArcotOTPMasterKeyConfigs.
     * 
    ...
    /**
     * Sets the globalConfigs value for this ConfigurationObjectListArcotOTPMasterKeyConfigs.
     * 
    ...
    /**
     * Gets the orgLevelConfigs value for this ConfigurationObjectListArcotOTPMasterKeyConfigs.
     * 
    ...
    /**
     * Sets the orgLevelConfigs value for this ConfigurationObjectListArcotOTPMasterKeyConfigs.
     * 
    ...
    /**
     * Gets the defaultConfigName value for this ConfigurationObjectListArcotOTPMasterKeyConfigs.
     * 
     * @return defaultConfigName   * Default arcotOTP master key configuration name
     * 									to
     * 									the organization.
     * 									The default configuration is present in
     * 									either globalConfigs or
    ...
    /**
     * Sets the defaultConfigName value for this ConfigurationObjectListArcotOTPMasterKeyConfigs.
     * 
     * @param defaultConfigName   * Default arcotOTP master key configuration name
     * 									to
     * 									the organization.
     * 									The default configuration is present in
     * 									either globalConfigs or
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConfigurationObjectListArcotOTPMasterKeyConfigs)) return false;
        ConfigurationObjectListArcotOTPMasterKeyConfigs other = (ConfigurationObjectListArcotOTPMasterKeyConfigs) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConfigurationObjectListArcotOTPMasterKeyConfigs.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.arcot.com/ArcotWebFortAdminSvc/7.0/xsd", ">ConfigurationObjectList>arcotOTPMasterKeyConfigs"));
