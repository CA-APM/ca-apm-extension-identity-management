/**
 * ConfigurationObjectListEmvAuthConfigs.java
 *
 ...
 */
public class ConfigurationObjectListEmvAuthConfigs  implements java.io.Serializable {
    /* These configurations are configured at global
     * 									level, but associated to the organization. */
    private com.arcot.ws.ArcotWebFortAdminSvc._7_0.xsd.EMVAuthConfig[] globalConfigs;

    /* These configurations are configured and
     * 									associated to the organization. */
    private com.arcot.ws.ArcotWebFortAdminSvc._7_0.xsd.EMVAuthConfig[] orgLevelConfigs;

    /* Default EMV authentication configuration name
     * 									to
     * 									the organization.
    ...
    public ConfigurationObjectListEmvAuthConfigs() {
    }

    public ConfigurationObjectListEmvAuthConfigs(
           com.arcot.ws.ArcotWebFortAdminSvc._7_0.xsd.EMVAuthConfig[] globalConfigs,
           com.arcot.ws.ArcotWebFortAdminSvc._7_0.xsd.EMVAuthConfig[] orgLevelConfigs,
    ...
    /**
     * Gets the globalConfigs value for this ConfigurationObjectListEmvAuthConfigs.
     * 
     * @return globalConfigs   * These configurations are configured at global
     * 									level, but associated to the organization.
     */
    public com.arcot.ws.ArcotWebFortAdminSvc._7_0.xsd.EMVAuthConfig[] getGlobalConfigs() {
        return globalConfigs;
    }


    /**
     * Sets the globalConfigs value for this ConfigurationObjectListEmvAuthConfigs.
     * 
     * @param globalConfigs   * These configurations are configured at global
     * 									level, but associated to the organization.
     */
    public void setGlobalConfigs(com.arcot.ws.ArcotWebFortAdminSvc._7_0.xsd.EMVAuthConfig[] globalConfigs) {
        this.globalConfigs = globalConfigs;
    }

    public com.arcot.ws.ArcotWebFortAdminSvc._7_0.xsd.EMVAuthConfig getGlobalConfigs(int i) {
        return this.globalConfigs[i];
    }

    public void setGlobalConfigs(int i, com.arcot.ws.ArcotWebFortAdminSvc._7_0.xsd.EMVAuthConfig _value) {
        this.globalConfigs[i] = _value;
    }


    /**
     * Gets the orgLevelConfigs value for this ConfigurationObjectListEmvAuthConfigs.
     * 
     * @return orgLevelConfigs   * These configurations are configured and
     * 									associated to the organization.
     */
    public com.arcot.ws.ArcotWebFortAdminSvc._7_0.xsd.EMVAuthConfig[] getOrgLevelConfigs() {
        return orgLevelConfigs;
    }


    /**
     * Sets the orgLevelConfigs value for this ConfigurationObjectListEmvAuthConfigs.
     * 
     * @param orgLevelConfigs   * These configurations are configured and
     * 									associated to the organization.
     */
    public void setOrgLevelConfigs(com.arcot.ws.ArcotWebFortAdminSvc._7_0.xsd.EMVAuthConfig[] orgLevelConfigs) {
        this.orgLevelConfigs = orgLevelConfigs;
    }

    public com.arcot.ws.ArcotWebFortAdminSvc._7_0.xsd.EMVAuthConfig getOrgLevelConfigs(int i) {
        return this.orgLevelConfigs[i];
    }

    public void setOrgLevelConfigs(int i, com.arcot.ws.ArcotWebFortAdminSvc._7_0.xsd.EMVAuthConfig _value) {
        this.orgLevelConfigs[i] = _value;
    }


    /**
     * Gets the defaultConfigName value for this ConfigurationObjectListEmvAuthConfigs.
     * 
     * @return defaultConfigName   * Default EMV authentication configuration name
     * 									to
     * 									the organization.
     * 									The default configuration is present in
     * 									either globalConfigs or
    ...
    /**
     * Sets the defaultConfigName value for this ConfigurationObjectListEmvAuthConfigs.
     * 
     * @param defaultConfigName   * Default EMV authentication configuration name
     * 									to
     * 									the organization.
     * 									The default configuration is present in
     * 									either globalConfigs or
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConfigurationObjectListEmvAuthConfigs)) return false;
        ConfigurationObjectListEmvAuthConfigs other = (ConfigurationObjectListEmvAuthConfigs) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConfigurationObjectListEmvAuthConfigs.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.arcot.com/ArcotWebFortAdminSvc/7.0/xsd", ">ConfigurationObjectList>emvAuthConfigs"));
