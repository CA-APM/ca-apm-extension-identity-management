...
/**
 * OATHAuthConfig is the structure used to
 * 				represent
 * 				authentication configuration for
 * 				OATH credential. These configuration settings
 * 				will be used while authenticating with OATH
 * 				by the user.
 */
public class OATHAuthConfig  extends com.arcot.ws.ArcotWebFortAdminSvc._7_0.xsd.BaseWFAuthConfig  implements java.io.Serializable {
    ...
    /**
     * Gets the otpCounterTolerance value for this OATHAuthConfig.
     * 
    ...
    /**
     * Sets the otpCounterTolerance value for this OATHAuthConfig.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OATHAuthConfig)) return false;
        OATHAuthConfig other = (OATHAuthConfig) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OATHAuthConfig.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.arcot.com/ArcotWebFortAdminSvc/7.0/xsd", "OATHAuthConfig"));
