...
/**
 * EMV AuthPolicy is the structure used to
 * 				represent
 * 				authentication configuration for
 * 				EMV OTP credential. These configuration settings
 * 				will be used while authenticating with EMV by
 * 				the user.
 */
public class EMVAuthConfig  extends com.arcot.ws.ArcotWebFortAdminSvc._7_0.xsd.BaseWFAuthConfig  implements java.io.Serializable {
    ...
    /**
     * Gets the otpCounterTolerance value for this EMVAuthConfig.
     * 
    ...
    /**
     * Sets the otpCounterTolerance value for this EMVAuthConfig.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof EMVAuthConfig)) return false;
        EMVAuthConfig other = (EMVAuthConfig) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EMVAuthConfig.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.arcot.com/ArcotWebFortAdminSvc/7.0/xsd", "EMVAuthConfig"));
