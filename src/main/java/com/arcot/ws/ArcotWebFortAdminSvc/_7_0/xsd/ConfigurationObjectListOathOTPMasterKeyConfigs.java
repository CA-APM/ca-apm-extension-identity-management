/**
 * ConfigurationObjectListOathOTPMasterKeyConfigs.java
 *
...
public class ConfigurationObjectListOathOTPMasterKeyConfigs  implements java.io.Serializable {
    ...
    /* Default OATH OTP master key configuration name
     * 									to
     * 									the organization.
    ...
    public ConfigurationObjectListOathOTPMasterKeyConfigs() {
    }
    ...
    /**
     * Gets the globalConfigs value for this ConfigurationObjectListOathOTPMasterKeyConfigs.
     * 
    ...
    /**
     * Sets the globalConfigs value for this ConfigurationObjectListOathOTPMasterKeyConfigs.
     * 
    ...
    /**
     * Gets the orgLevelConfigs value for this ConfigurationObjectListOathOTPMasterKeyConfigs.
     * 
    ...
    /**
     * Sets the orgLevelConfigs value for this ConfigurationObjectListOathOTPMasterKeyConfigs.
     * 
    ...
    /**
     * Gets the defaultConfigName value for this ConfigurationObjectListOathOTPMasterKeyConfigs.
     * 
     * @return defaultConfigName   * Default OATH OTP master key configuration name
     * 									to
     * 									the organization.
     * 									The default configuration is present in
     * 									either globalConfigs or
    ...
    /**
     * Sets the defaultConfigName value for this ConfigurationObjectListOathOTPMasterKeyConfigs.
     * 
     * @param defaultConfigName   * Default OATH OTP master key configuration name
     * 									to
     * 									the organization.
     * 									The default configuration is present in
     * 									either globalConfigs or
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConfigurationObjectListOathOTPMasterKeyConfigs)) return false;
        ConfigurationObjectListOathOTPMasterKeyConfigs other = (ConfigurationObjectListOathOTPMasterKeyConfigs) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConfigurationObjectListOathOTPMasterKeyConfigs.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.arcot.com/ArcotWebFortAdminSvc/7.0/xsd", ">ConfigurationObjectList>oathOTPMasterKeyConfigs"));
