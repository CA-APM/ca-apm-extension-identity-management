/**
 * ConfigurationObjectListCredTypeResolutionConfigs.java
 *
...
public class ConfigurationObjectListCredTypeResolutionConfigs  implements java.io.Serializable {
    ...
    /* Default Credntial type resolution
    ...
    public ConfigurationObjectListCredTypeResolutionConfigs() {
    }
    ...
    /**
     * Gets the globalConfigs value for this ConfigurationObjectListCredTypeResolutionConfigs.
     * 
    ...
    /**
     * Sets the globalConfigs value for this ConfigurationObjectListCredTypeResolutionConfigs.
     * 
    ...
    /**
     * Gets the orgLevelConfigs value for this ConfigurationObjectListCredTypeResolutionConfigs.
     * 
    ...
    /**
     * Sets the orgLevelConfigs value for this ConfigurationObjectListCredTypeResolutionConfigs.
     * 
    ...
    /**
     * Gets the defaultConfigName value for this ConfigurationObjectListCredTypeResolutionConfigs.
     * 
     * @return defaultConfigName   * Default Credntial type resolution
     * 									configuration name to
     * 									the organization.
     * 									The default configuration
     * 									is present in either globalConfigs or
    ...
    /**
     * Sets the defaultConfigName value for this ConfigurationObjectListCredTypeResolutionConfigs.
     * 
     * @param defaultConfigName   * Default Credntial type resolution
     * 									configuration name to
     * 									the organization.
     * 									The default configuration
     * 									is present in either globalConfigs or
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConfigurationObjectListCredTypeResolutionConfigs)) return false;
        ConfigurationObjectListCredTypeResolutionConfigs other = (ConfigurationObjectListCredTypeResolutionConfigs) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConfigurationObjectListCredTypeResolutionConfigs.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.arcot.com/ArcotWebFortAdminSvc/7.0/xsd", ">ConfigurationObjectList>credTypeResolutionConfigs"));
