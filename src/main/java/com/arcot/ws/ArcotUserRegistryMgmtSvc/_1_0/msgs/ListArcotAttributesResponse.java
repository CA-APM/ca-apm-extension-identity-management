/**
 * ListArcotAttributesResponse.java
 *
...
public class ListArcotAttributesResponse  implements java.io.Serializable {
    private java.lang.String[] attributeList;

    public ListArcotAttributesResponse() {
    }
    ...
    /**
     * Gets the attributeList value for this ListArcotAttributesResponse.
     * 
    ...
    /**
     * Sets the attributeList value for this ListArcotAttributesResponse.
     * 
     * @param attributeList
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ListArcotAttributesResponse)) return false;
        ListArcotAttributesResponse other = (ListArcotAttributesResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ListArcotAttributesResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.arcot.com/ArcotUserRegistryMgmtSvc/1.0/msgs", ">listArcotAttributesResponse"));
