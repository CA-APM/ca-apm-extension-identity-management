...
public class GetUserStatusRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the userId value for this GetUserStatusRequest.
     * 
     * @return userId
     */
    ...
    /**
     * Sets the userId value for this GetUserStatusRequest.
     * 
     * @param userId
     */
    ...
    /**
     * Gets the clientTxId value for this GetUserStatusRequest.
     * 
     * @return clientTxId
     */
    ...
    /**
     * Sets the clientTxId value for this GetUserStatusRequest.
     * 
     * @param clientTxId
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.arcot.com/ArcotUserRegistrySvc/1.0/msgs", ">getUserStatusRequest"));
