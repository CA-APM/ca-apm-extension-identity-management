...
public class DeleteUserRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the clientTxId value for this DeleteUserRequest.
     * 
     * @return clientTxId
     */
    ...
    /**
     * Sets the clientTxId value for this DeleteUserRequest.
     * 
     * @param clientTxId
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.arcot.com/ArcotUserRegistrySvc/1.0/msgs", ">deleteUserRequest"));
